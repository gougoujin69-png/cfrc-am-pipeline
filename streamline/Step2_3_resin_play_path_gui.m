...
function play_path_animation_gui()
    ...
    function loadCallback(~, ~)
        ...
        % Check data
        if ~isfield(connected_layers_data, 'resin_connected_paths') || ...
           isempty(connected_layers_data(layer).resin_connected_paths)
            set(info_label, 'String', 'No data!');
            return;
        end
        
        paths = connected_layers_data(layer).resin_connected_paths;
