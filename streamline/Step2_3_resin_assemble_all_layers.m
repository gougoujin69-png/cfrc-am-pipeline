...
SPIRAL_MERGE_THRESHOLD = 10;      % mm (螺旋与螺旋之间触发融合的距离)
...
for layer = 1:num_layers
    ...
    if isempty(paths_3dr), continue; end
    
    % --- Step A: Original Loop to Spiral Assembly ---
    loops = paths_3dr; % 假设已经是 cell array
    ...
    all_layers_data(layer).resin_connected_paths = final_output_paths;
...
if ~isempty(all_layers_data(1).resin_connected_paths)
    sample_paths = all_layers_data(1).resin_connected_paths;
