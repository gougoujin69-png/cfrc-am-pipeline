...
nl = 0;%初始层高
phead = 'Main';%%Main
firstl =  57.36e-3+0.20e-3-0.75e-3;%%%%此处为测试底板高度
...
y=-1.5;
z=0.2;
filename = ['test1',phead,'.mod'];
YM = xlsread('test1.xlsx');
